...
export const routes: Routes = [
  ...
  { path: 'events/:eventId/edit', component: EventEditComponent, canActivate: [authGuard] },
  { path: 'events/:eventId/ticket-categories/create', component: TicketCategoryCreateComponent, canActivate: [authGuard] },
  { path: 'events/:eventId/ticket-categories/:categoryId/edit', component: TicketCategoryEditComponent, canActivate: [authGuard] },
  ...
  { path: 'my-sessions', component: SpeakerSessions, canActivate: [authGuard] },
